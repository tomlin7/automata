...
export default function REToDFAPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#E15C3A" }}>
      {/* Header */}
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl font-bold text-white truncate">RE → DFA</h1>
                <p className="text-xs sm:text-sm text-white/80 truncate">RE to DFA easily</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <ChatInterface
        ...
        isLoading={isLoading}
        examples={examples}
        placeholder="RE you want to convert..."
